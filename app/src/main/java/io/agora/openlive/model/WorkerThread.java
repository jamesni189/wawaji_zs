...
//        }
    ...
    public final void joinChannel(String channelKey,final String channel, int uid) {
    ...
    //    ensureRtcEngineReadyLock();
        //FIXME czhang 填入channelKey
        //mRtcEngine.joinChannel(channelKey, channel, "OpenLive", uid);
  ...
  /*  private RtcEngine ensureRtcEngineReadyLock() {
        if (mRtcEngine == null) {
            ...
            if (TextUtils.isEmpty(appId)) {
                throw new RuntimeException("NEED TO use your App ID, get your own ID at https://dashboard.io.agora.io/");
            }
            try {
            ...
            mRtcEngine.setLogFile(Environment.getExternalStorageDirectory()
                    + File.separator + mContext.getPackageName() + "/log/io.agora-rtc.log");
            mRtcEngine.enableDualStreamMode(true);
        }
        return mRtcEngine;
    }*/
