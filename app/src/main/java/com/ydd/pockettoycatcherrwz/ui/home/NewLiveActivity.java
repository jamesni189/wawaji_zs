...
public class NewLiveActivity extends BaseActivity implements AGEventHandler {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.ln_live_recharge:
                    // 充值
                 //   startActivity(new Intent(NewLiveActivity.this, Recharge_newActivity.class));
                    startActivity(new Intent(NewLiveActivity.this, RechargeNewActivity.class));
                    //	showRechargeDialog();
                    break;
...
//        li_point_top.setText(RunningContext.loginTelInfo.points+"");
    ...
    * */
    private void joinRoom(){
        ...
        joinParam.nickname = RunningContext.usernickname;
