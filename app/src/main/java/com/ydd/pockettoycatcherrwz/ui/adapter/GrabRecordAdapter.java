...
public class GrabRecordAdapter extends BaseAdapter {
	...
	public GrabRecordAdapter(Context context) {
	...
	public View getView(final int i, View view, ViewGroup viewGroup) {
		...
		ImgLoaderUtil.displayImage(records.get(i).img, viewHoler.dollimg,
	...
	/*	ImgLoaderUtil.displayImage(records.get(i).avatar, viewHoler.dollimg,
		...
		if (!TextUtils.isEmpty(records.get(i).createTime)) {
			...
			String time = dateUitls(records.get(i).createTime);
		...
		viewHoler.dollimg.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (records.get(i).url != null) {
					Intent intent = new Intent();
					intent.setClass(context, VideoActivity.class);
					intent.putExtra(VideoActivity.INTENT_EXTRA_URL, records.get(i).url);
