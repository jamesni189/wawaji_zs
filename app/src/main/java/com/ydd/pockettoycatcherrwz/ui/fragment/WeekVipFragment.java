 ...
 * {@link WeekVipFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WeekVipFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WeekVipFragment extends Fragment implements View.OnClickListener{
     ...
     * @return A new instance of fragment WeekVipFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WeekVipFragment newInstance(String param1, String param2) {
        WeekVipFragment fragment = new WeekVipFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        initviews(view);
        initdatas();
        tv_vip_add_money.setOnClickListener(this);
        tv_get_jiangli.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_get_jiangli:

              /*  if (resultData.week!= null) {
                    Intent intent = new Intent(getActivity(), LookForDeter_Activity.class);
                    intent.putExtra("kinds", 1);
                    intent.putExtra("VIP_week", resultData.week);
                    startActivity(intent);
                }*/
                break;
        }
