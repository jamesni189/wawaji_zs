 ...
 *
 */
public class LiveActivityNew extends BaseActivity implements View.OnLayoutChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  if (RunningContext.loginTelInfo == null) {
        ...
        messageAdapter = new MessageAdapter(LiveActivityNew.this);
        list_message.setAdapter(messageAdapter);
        mAdapter = new NewGrabRecordAdapter(LiveActivityNew.this);
    ...
    public void initRoomInfo(String machineId) {
        BusinessManager.getInstance().enterRoomByMachine(new EnterMachineRequest(RunningContext.accessToken, machineId), new MyCallback<RoomItem>() {
            ...
            public void onError(String errorCode, String message) {
               Log.i("===",message);
               Toast.makeText(LiveActivityNew.this,message,Toast.LENGTH_SHORT).show();
            }
    ...
    private void initView() {
        ...
        galleryAdapter = new GalleryAdapter(LiveActivityNew.this);
...
//        avatar_list.setAdapter(memberAdapter);
        ...
        picAdapter = new ImageShowAdapter(LiveActivityNew.this);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.ln_live_details: //发言
                    ...
                    inputComment(LiveActivityNew.this,list_message,mLiveStart);
                ...
                case R.id.ln_live_recharge:
                    // 充值
                   // startActivity(new Intent(LiveActivityNew.this, Recharge_newActivity.class));
                    startActivity(new Intent(LiveActivityNew.this, RechargeNewActivity.class));
                    //     showRechargeDialog();
                    break;
