...
public class StrokeTextView extends TextView {
	...
	public StrokeTextView(Context context, AttributeSet attrs) {
		...
		// 获取对应的属性值
		this.mInnerColor = a.getColor(R.styleable.StrokeTextView_innnerColor,
				Color.WHITE);
		this.mOuterColor = a.getColor(R.styleable.StrokeTextView_outerColor,
				Color.BLACK);
	}

	public StrokeTextView(Context context, AttributeSet attrs, int defStyle,
			int outerColor, int innnerColor) {
	...
	protected void onDraw(Canvas canvas) {
		if (m_bDrawSideLine) {
			...
			m_TextPaint.setStrokeWidth(mSize); // 描边宽度
	...
	public void setBlackStroke(int size) {
		mSize = size;
		invalidate();
	}
