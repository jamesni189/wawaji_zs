...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	private Paint mColorLinePaint = new Paint(ANTI_ALIAS_FLAG);;
	...
	private int mAutoScrollCount = -1;
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		mColorLinePaint.setStyle(Style.STROKE);
		mColorLinePaint.setStrokeWidth(2);
		mColorLinePaint.setColor(a.getColor(
				R.styleable.CirclePageIndicator_fillColor,
	...
	public void setDivder(float offset){
		this.mOffset = offset;
	}
	...
	public void setAutoScrollCount(int count) {
		this.mAutoScrollCount = count;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		final float threeRadius = mRadius * 2 + 4 + mOffset;
...
//				canvas.drawCircle(dX, dY, mRadius, mColorLinePaint);
			}
...
//		canvas.drawCircle(dX, dY, mRadius, mColorLinePaint);
	...
	public void setCurrentItem(int item) {
		...
		if (mAutoScrollCount > 0) {
			mCurrentPage = mCurrentPage % mAutoScrollCount;
		}
		invalidate();
	}
	...
	public void onPageScrolled(int position, float positionOffset,
		...
		if (mAutoScrollCount > 0) {
			mCurrentPage = position % mAutoScrollCount;
		}
		mPageOffset = 0;
		invalidate();
